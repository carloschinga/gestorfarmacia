    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String logi = session.getAttribute("logiUsua").toString();
                String nombre = session.getAttribute("nombUsua").toString();
                String nivel = session.getAttribute("nombRol").toString();
                if (logueado == null) {
